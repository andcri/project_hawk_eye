...
namespace detail {
    ...
    public:
        ...
        static auto logicError( std::string const &message ) -> BasicResult { return { ResultBase::LoggicError, message }; }
    ...
    protected:
        void enforceOk() const override {
            ...
            assert( m_type != ResultBase::LoggicError );
